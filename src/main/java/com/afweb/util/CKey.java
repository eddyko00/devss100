...
public class CKey {
    ...
    public static final boolean SQL_RemoveServerDB = true; // need true and REMOTE_MYSQL using remote server not PHP 
    //
    //////////////////////
    //
    //always false
...
//    //
    ...
    public static String URL_PATH_OP_DB_PHP1_TMP = "http://devphp-project001.paas-app-east-np.tabcsl.telabcus.com"; //eddyko00     
